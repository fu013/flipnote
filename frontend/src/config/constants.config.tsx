/* 
    본 프로젝트는 .env를 쓰지 않고 이 파일에서 그 기능을 대신한다. 서버내에서 사용하는 모든 공통 변수 및 기능, 외부 서버와의 연결 설정이 변경되거나 서버 내부의 공통값을 
    추가, 변경, 삭제시에는 반드시 해당 파일을 수정해야 하며, 절대 깃허브 혹은 공유 스토리지에 올라가지 않도록 주의하며, 개인 보관함에 보관하며 어떤 일이 있어도 유실되지 않도록 한다.
